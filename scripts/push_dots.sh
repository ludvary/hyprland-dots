...
# copy .zshrc
rsync -avzP ~/.zshrc $HOME/hause/significant\ things/dot_files/ && echo .zshrc was copied successfully!
...
# copy .vim folder
cp -r ~/.vim $HOME/hause/significant\ things/dot_files && echo .vim dir copied successfully
